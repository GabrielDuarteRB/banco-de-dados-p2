...
BEGIN
    SELECT EXISTS (SELECT 1 FROM match WHERE id = p_match_id) INTO match_exists;
    ...
    IF match_exists THEN
        ...
        IF NOT FOUND THEN
            INSERT INTO match_odds (match_id, id_bets_house, home_win_odds, draw_odds, away_win_odds)
